...
import { type ExtendedNativeTabOptions, type NativeTabTriggerProps } from './types';
...
export declare function appendIconOptions(options: ExtendedNativeTabOptions, props: NativeTabsTriggerIconProps): void;
